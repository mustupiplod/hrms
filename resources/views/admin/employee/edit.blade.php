            ...
            <div class="col-md-5">
                ...
                <div class="form-group " style="margin-top: 25px;">
                    ...
                    <select name="parent_department" class="form-control">
                        <option value="{{$employee->parent_department}}">{{$employee->parent_department}}</option>
...
{{--                        @endforeach--}}
{{--                    </select>--}}
                    <input type="text" name="department_lead" class="form-control" value="{{$employee->department_lead}}">
                </div>
                <div class="form-group " style="margin-top: 25px;">
