    ...
    <div class="col-md-5 col-md-offset-3 ">
        <form action="{{route('admin.shift.update',$shifts->id)}}" method="post">
            ...
            <div class="form-group " style="margin-top: 25px; ">
                ...
                <input type="text" class="form-control" name="type" value="{{$shifts->type}}">
            </div>
            <div class="form-group " style="margin-top: 25px; ">
                <label for="">Start-Time: </label>
                <input type="time" id="time1" class="form-control" name="start_time" value="{{$shifts->start_time}}">
            </div>
            <div class="form-group">
                <label for="">End-Time</label>
                <input type="time" id="time2" class="form-control" name="end_time" value="{{$shifts->end_time}}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group " style="margin-top: 25px;">
                ...
                <select name="is_active" id="" class="form-control">
                    @if($shifts->is_active == 0)
                        <option value="{{$shifts->is_active}}">Active</option>
                    @else
                        <option value="{{$shifts->is_active}}">Inactive</option>
                    @endif
