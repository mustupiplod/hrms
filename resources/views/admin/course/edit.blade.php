        ...
        <div class="col-md-5 col-md-offset-3 ">
            ...
            <form action="{{route('admin.course.update',['id'=>$course->id])}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <img id="blah" src="{{ asset('course/'.$course->course_name.'/'.$course->image) }}" class="" width="200" height="150"/>
                </div>
                ...
                <div class="form-group " style="margin-top: 25px;">
                    ...
                    <select name="questionnaire" class="form-control">
                        <option value="{{$course->questionnaire}}">{{$course->question_name}}</option>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="pass_criteria" onkeypress="return Validate(event);" class="form-control" value="{{$course->pass_criteria}}">
                </div>

                <div class="form-group " style="margin-top: 25px; ">
                    <label>Trainer <b style="color: red;">*</b></label>
                    <select name="trainer" class="form-control">
                        <option value="{{$course->trainer}}">{{$course->f_name}} {{$course->l_name}}</option>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="start_date" name="start_date" class="form-control"
                                   autocomplete="off" value="{{$course->start_date}}">
                        </div>
                        <div class="col-md-6">
                            <label>End Date <b style="color: red;">*</b></label>
                            <input type="text" id="end_date" name="end_date" class="form-control" autocomplete="off" value="{{$course->end_date}}">
                        </div>
                    </div>
                </div>
                <div class="form-group " style="margin-top: 25px;">
                    ...
                    <select name="assign_to" class="form-control">
                        <option value="{{$course->assign_to}}">{{$course->assign_to}}</option>
